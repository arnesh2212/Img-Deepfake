...
parser.add_argument('-chk_dir','--checkpoint_dir', type=str, help="The dir path for storing checkpointed models.",required=True)
parser.add_argument('-run_n', '--run_name', type=str, help="Name of the albation/run to be done.",required=True)
parser.add_argument('-test_res_n','--test_results_filename',type=str,help="The dir path to save the test metrics",required=True)
args = parser.parse_args()


CFG = {
    "project": "deepfake-freq-dinov3-albations",
    "entity": None,
    "epochs": 20,
    "batch_size": 32,
    "val_batch_size": 32,
...
os.makedirs(CFG[args.checkpoint_dir], exist_ok=True)

# IMPORT THE MODEL FOR ALBATION
if args.run_name=='alb1':
    from src.models import alba1 as FreqDINO   #Model Class to import for albation 1
elif args.run_name=='alb2':
    from src.models import alba2 as FreqDINO   #Model Class to import for albation 2
elif args.run_name=='alb3':
    from src.models import alba3 as FreqDINO  #Model Class to import for albation 3
elif args.run_name=='alb4':
    from src.models import alba4 as FreqDINO   #Model Class to import for albation 4
elif args.run_name=='alb5':
    from src.models import alba5 as FreqDINO   #Model Class to import for albation 5
